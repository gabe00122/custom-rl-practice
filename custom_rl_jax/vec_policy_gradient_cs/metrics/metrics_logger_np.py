...
class MetricsLoggerNP:
    ...
    def __init__(self, total_steps: int):
        ...
        self.state_value = np.zeros(total_steps)
        self.td_error = np.zeros(total_steps)
        self.actor_loss = np.zeros(total_steps)
        self.critic_loss = np.zeros(total_steps)
        self.entropy = np.zeros(total_steps)
