...
FinishedRewardRecorderState = TypedDict("FinishedRewardRecorderState", {
...
class FinishedRewardRecorder:
    ...
    @partial(jax.jit, static_argnums=0)
    def update(self, state: FinishedRewardRecorderState, done: Array, step_rewards: Array) -> tuple[FinishedRewardRecorderState, Array]:
